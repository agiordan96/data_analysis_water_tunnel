function [] = plot_CD(wingtype, sel_inflation, sel_inflation_double, exp_value, exp_value_hard, exp_value_double, sel_speed, div, chord, kin_viscosity, drag_dir, plot_type, format)
        ...
        for j = 1:length(sel_speed) % looping over flow speed to create fixed-speed plots
            ...
            for k = 1:length(exp_value.f_avg)
                 ...
                 if (exp_value.vel(k) == sel_speed(j))
                    if exist('k1','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(1, j)), exp_value.f_std(k, drag_dir) / div(1, j), 'o', 'DisplayName', 'neutral', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#B02013', MarkerEdgeColor = '#B02013')
                    else
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(1, j)), exp_value.f_std(k, drag_dir) / div(1, j), 'o', 'HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#B02013', MarkerEdgeColor = '#B02013')
        ...
        for j = 1:length(sel_speed) % looping over flow speed to create fixed-speed plots
            ...
            for k = 1:length(exp_value.f_avg)
                 ...
                 if (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(1))
                    if exist('k1','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(1, j)), exp_value.f_std(k, drag_dir) / div(1, j), 'o', 'DisplayName', 'neutral', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
                    else
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(1, j)), exp_value.f_std(k, drag_dir) / div(1, j), 'o', 'HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
                        x_vec = [exp_value.aoa(k1), exp_value.aoa(k)];
                        y_vec = [(-exp_value.f_avg(k1, drag_dir) / div(1, j)), (-exp_value.f_avg(k, drag_dir) / div(1, j))];
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(2))
                     if exist('k2','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(2, j)), exp_value.f_std(k, drag_dir) / div(2, j), 'o', 'DisplayName', '30 mL inf.', 'CapSize', 18, 'MarkerFaceColor', 'k', 'LineWidth', 1, MarkerEdgeColor = 'black')
                     else
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(4))
                     if exist('k4','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(4, j)), exp_value.f_std(k, drag_dir) / div(4, j), 'o', 'DisplayName', '90 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
                     else
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(4, j)), exp_value.f_std(k, drag_dir) / div(4, j), 'o', 'HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(5))
                     if exist('k5','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(5, j)), exp_value.f_std(k, drag_dir) / div(5, j), 'o', 'DisplayName', '120 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
                     else
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(5, j)), exp_value.f_std(k, drag_dir) / div(5, j), 'o', 'HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#A47E3B', MarkerEdgeColor = '#A47E3B')
    ...
    elseif wingtype == "soft_hard"
        ...
        for j = 1:length(sel_speed) % looping over flow speed to create fixed-speed plots
            ...
            legend('Location','north','Orientation','horizontal','fontsize', 35, 'LineWidth', 2)
            ...
            for k = 1:length(exp_value.f_avg)
                ...
                if k <= length(exp_value_hard.vel)
                    if (exp_value_hard.vel(k) == sel_speed(j))
                        if exist('hard1','var') == 0
                            errorbar(exp_value_hard.aoa(k), (-exp_value_hard.f_avg(k, drag_dir) / div(1, j)), exp_value_hard.f_std(k, drag_dir) / div(1, j), 'o', 'Color', '#383B3E', 'DisplayName', '–– rigid', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor='#383B3E')
                        else
                            errorbar(exp_value_hard.aoa(k), (-exp_value_hard.f_avg(k, drag_dir) / div(1, j)), exp_value_hard.f_std(k, drag_dir) / div(1, j), 'o', 'Color', '#383B3E', 'HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor='#383B3E')
                ...
                if sel_speed(j) == double_vel 
                      ...
                      elseif exp_value_double.inflation(k) == sel_inflation_double(2)
                        if exp_value_double.dir(k) == 1
                         if exist('d2','var') == 0
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#C9459A','DisplayName', '15 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#C9459A', MarkerEdgeColor = '#C9459A')
                         else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#C9459A','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#C9459A', MarkerEdgeColor = '#C9459A')
                     ...
                     elseif exp_value_double.inflation(k) == sel_inflation_double(3) 
                       if exp_value_double.dir(k) == 1 
                         if exist('d3','var') == 0
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#BC3F02','DisplayName', '30 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
                         else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#BC3F02','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
                      ...
                      elseif exp_value_double.inflation(k) == sel_inflation_double(4)
                        if exp_value_double.dir(k) == 1
                         if exist('d4','var') == 0
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#ED9B00','DisplayName', '45 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#ED9B00', MarkerEdgeColor = '#ED9B00')
                         else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(2, j)), exp_value_double.f_std(k, drag_dir) / div(2, j), 'o', 'Color', '#ED9B00','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#ED9B00', MarkerEdgeColor = '#ED9B00')
                     ...
                     elseif exp_value_double.inflation(k) == sel_inflation_double(5)
                       if exp_value_double.dir(k) == 1
                         if exist('d5','var') == 0
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(3, j)), exp_value_double.f_std(k, drag_dir) / div(3, j), 'o', 'Color', '#E9D8A4','DisplayName', '60 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#E9D8A4', MarkerEdgeColor = '#E9D8A4')
                         else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(3, j)), exp_value_double.f_std(k, drag_dir) / div(3, j), 'o', 'Color', '#E9D8A4','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#E9D8A4', MarkerEdgeColor = '#E9D8A4')
                     ...
                     elseif exp_value_double.inflation(k) == sel_inflation_double(6)
                       if exp_value_double.dir(k) == 1
                         if exist('d6','var') == 0
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(4, j)), exp_value_double.f_std(k, drag_dir) / div(4, j), 'o', 'Color', '#93D2BD','DisplayName', '90 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#93D2BD', MarkerEdgeColor = '#93D2BD')
                         else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(4, j)), exp_value_double.f_std(k, drag_dir) / div(4, j), 'o', 'Color', '#93D2BD','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#93D2BD', MarkerEdgeColor = '#93D2BD')
                     ...
                     elseif exp_value_double.inflation(k) == sel_inflation_double(7)
                       if exp_value_double.dir(k) == 1
                        if exist('d7','var') == 0 
                         errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(5, j)), exp_value_double.f_std(k, drag_dir) / div(5, j), 'o', 'Color', '#005F73','DisplayName', '120 mL inf.', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#005F73', MarkerEdgeColor = '#005F73')
                        else
                            errorbar(exp_value_double.aoa(k), (-exp_value_double.f_avg(k, drag_dir) / div(5, j)), exp_value_double.f_std(k, drag_dir) / div(5, j), 'o', 'Color', '#005F73','HandleVisibility','off', 'CapSize', 18, 'LineWidth', 1, MarkerFaceColor = '#005F73', MarkerEdgeColor = '#005F73')
                  ...
                  if (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(1))
                    if exist('k1','var') == 0
                        errorbar(exp_value.aoa(k), (-exp_value.f_avg(k, drag_dir) / div(1, j)), exp_value.f_std(k, drag_dir) / div(1, j), 'o', 'Color', '#383B3E', 'DisplayName', '– – neutral', 'CapSize', 18,  'LineWidth', 1, MarkerFaceColor = '#383B3E', MarkerEdgeColor = '#383B3E')
                    else
