function [] = plot_medianCLCD(wingtype, sel_inflation, sel_inflation_double, exp_value, exp_value_hard, exp_value_double, sel_speed, div, chord, kin_viscosity, plot_type, format, lift_dir, drag_dir)
    ...
    for j = 1:length(sel_speed) % looping over flow speed to create fixed-speed plots
        ...
        for k = 1:length(exp_value.f_median)
            if (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(1))
                if exist('k1','var') == 0
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 30,'or', 'DisplayName', 'neutral', 'MarkerFaceColor', 'r', 'LineWidth', 1, MarkerEdgeColor = 'red')
                else
                   scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 30,'or', 'HandleVisibility','off', 'MarkerFaceColor', 'r', 'LineWidth', 1, MarkerEdgeColor = 'red')
                   x_vec = [exp_value.aoa(k1), exp_value.aoa(k)];
             ...
             elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(2))
                 if exist('k2','var') == 0
                 scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'ok', 'DisplayName', 'inf. = 60 mL', 'MarkerFaceColor', 'k', 'LineWidth', 1, MarkerEdgeColor = 'black')
                 else
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 40,'ok', 'HandleVisibility','off', 'MarkerFaceColor', 'k', 'LineWidth', 1, MarkerEdgeColor = 'black')
             ...
             elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(3))
                 if exist('k3','var') == 0
                 scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'om', 'DisplayName', 'inf. = 90 mL', 'MarkerFaceColor', 'm', 'LineWidth', 1, MarkerEdgeColor = 'magenta')
                 else
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'om', 'HandleVisibility','off', 'MarkerFaceColor', 'm', 'LineWidth', 1, MarkerEdgeColor = 'magenta')
             ...
             elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(4))
                 if exist('k4','var') == 0
                 scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 30,'ob', 'DisplayName', 'inf. = 120 mL', 'MarkerFaceColor', 'b', 'LineWidth', 1, MarkerEdgeColor = 'blue')
                 else
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 30,'ob', 'HandleVisibility','off', 'MarkerFaceColor', 'b', 'LineWidth', 1, MarkerEdgeColor = 'blue')
             ...
             elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(5))
                 if exist('k5','var') == 0
                scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 30,'og', 'DisplayName', 'inf. = 30 mL', 'MarkerFaceColor', 'g', 'LineWidth', 1, MarkerEdgeColor = 'green')
                 else
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'og', 'HandleVisibility','off', 'MarkerFaceColor', 'b', 'LineWidth', 1, MarkerEdgeColor = 'green')
  ...
  elseif wingtype == "soft_hard"
    ...
    for j = 1:length(sel_speed) % looping over flow speed to create fixed-speed plots
        ...
        xlim([-6 16])
        ylim([-3 8])
        yticks([-5 -2.5 0 2.5 5 7.5 10 12.5 15])
           ...
           if k <= length(exp_value_hard.vel)
                    if (exp_value_hard.vel(k) == sel_speed(j))
                        if exist('hard1','var') == 0
                            scatter(exp_value_hard.aoa(k), exp_value_hard.f_median(k, lift_dir) / exp_value_hard.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'DisplayName', '–– rigid',   'LineWidth', 1, MarkerFaceColor='#383B3E', MarkerEdgeColor='#383B3E')
                        else
                            scatter(exp_value_hard.aoa(k), exp_value_hard.f_median(k, lift_dir) / exp_value_hard.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor='#383B3E', MarkerEdgeColor='#383B3E')
...
%                             if exist('d1','var') == 0
%                                 scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'DisplayName', '– – neutral',    'LineWidth', 1, MarkerFaceColor = '#383B3E', MarkerEdgeColor = '#383B3E')
%                             else
%                                 scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#383B3E', MarkerEdgeColor = '#383B3E')
...
%                         if exp_value_double.dir(k) == 1
%                          if exist('d2','var') == 0
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#C9459A','DisplayName', '15 mL ',   'LineWidth', 1, MarkerFaceColor = '#C9459A', MarkerEdgeColor = '#C9459A')
%                          else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#C9459A', 'HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#C9459A', MarkerEdgeColor = '#C9459A')
...
%                        if exp_value_double.dir(k) == 1 
%                          if exist('d3','var') == 0
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#BC3F02','DisplayName','30 mL. ',   'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
%                          else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#BC3F02','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
...
%                         if exp_value_double.dir(k) == 1
%                          if exist('d4','var') == 0
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'DisplayName', '45 mL ', 'Color', '#ED9B00', 'LineWidth', 1, MarkerFaceColor = '#ED9B00', MarkerEdgeColor = '#ED9B00')
%                          else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#ED9B00','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#ED9B00', MarkerEdgeColor = '#ED9B00')
...
%                        if exp_value_double.dir(k) == 1
%                          if exist('d5','var') == 0
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#ebb81e','DisplayName', '60 mL ',   'LineWidth', 1, MarkerFaceColor = '#ebb81e', MarkerEdgeColor = '#ebb81e')
%                          else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#ebb81e','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#ebb81e', MarkerEdgeColor = '#ebb81e')
...
%                        if exp_value_double.dir(k) == 1
%                          if exist('d6','var') == 0
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#0A9C6B','DisplayName', '90 mL ',   'LineWidth', 1, MarkerFaceColor = '#0A9C6B', MarkerEdgeColor = '#0A9C6B')
%                          else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#0A9C6B','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#0A9C6B', MarkerEdgeColor = '#0A9C6B')
...
%                        if exp_value_double.dir(k) == 1
%                         if exist('d7','var') == 0 
%                          scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#1a91c2','DisplayName', '120 mL ',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
%                         else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 30,'o', 'Color', '#1a91c2','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
...
%                       elseif exp_value_double.dir(k) == 0
%                         if exist('d7n','var') == 0 
%                          scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#1a91c2','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
%                         else
%                             scatter(exp_value_double.aoa(k), exp_value_double.f_median(k, lift_dir) / exp_value_double.f_median(k, drag_dir), 100, 'o', 'Color', '#1a91c2','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
...
%             else
                ...
                if (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(1))
                    if exist('k1','var') == 0
                                scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'DisplayName', '– – neutral',    'LineWidth', 1, MarkerFaceColor = '#383B3E', MarkerEdgeColor = '#383B3E')
                    else
                                scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#383B3E', 'HandleVisibility','off',    'LineWidth', 1, MarkerFaceColor = '#383B3E', MarkerEdgeColor = '#383B3E')
                                x_vec = [exp_value.aoa(k1), exp_value.aoa(k)];
                                y_vec = [exp_value.f_median(k1, lift_dir) / exp_value.f_median(k1, drag_dir), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir)];
                                plot(x_vec, y_vec, '-.', 'Color', '#383B3E', 'HandleVisibility', 'off', 'LineWidth', 3)
                     end
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(2))
                     if exist('k2','var') == 0
                      scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#BC3F02','DisplayName', '30 mL ',   'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
                     else
                      scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#BC3F02','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#BC3F02', MarkerEdgeColor = '#BC3F02')
                        x_vec = [exp_value.aoa(k2), exp_value.aoa(k)];
                        y_vec = [exp_value.f_median(k2, lift_dir) / exp_value.f_median(k2, drag_dir), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir)];
                        plot(x_vec, y_vec, '-.', 'Color', '#BC3F02', 'HandleVisibility', 'off', 'LineWidth', 3)
                    end
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(3))
                     if exist('k3','var') == 0
                    scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#ebb81e','DisplayName', '60 mL ',   'LineWidth', 1, MarkerFaceColor = '#ebb81e', MarkerEdgeColor = '#ebb81e')
                     else
                        scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#ebb81e','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#ebb81e', MarkerEdgeColor = '#ebb81e')
                        x_vec = [exp_value.aoa(k3), exp_value.aoa(k)];
                        y_vec = [exp_value.f_median(k3, lift_dir) / exp_value.f_median(k3, drag_dir), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir)];
                        plot(x_vec, y_vec, '-.', 'Color', '#ebb81e', 'HandleVisibility', 'off', 'LineWidth', 3)
                    end
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(4))
                     if exist('k4','var') == 0
                        scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#0A9C6B','DisplayName', '90 mL ',   'LineWidth', 1, MarkerFaceColor = '#0A9C6B', MarkerEdgeColor = '#0A9C6B')
                     else
                        scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#0A9C6B','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#0A9C6B', MarkerEdgeColor = '#0A9C6B')
                        x_vec = [exp_value.aoa(k4), exp_value.aoa(k)];
                        y_vec = [exp_value.f_median(k4, lift_dir) / exp_value.f_median(k4, drag_dir), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir)];
                        plot(x_vec, y_vec, '-.', 'Color', '#0A9C6B', 'HandleVisibility', 'off', 'LineWidth', 3)
                    end
                 ...
                 elseif (exp_value.vel(k) == sel_speed(j)) && (exp_value.inflation(k) == sel_inflation(5))
                     if exist('k5','var') == 0
                      scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#1a91c2','DisplayName', '120 mL ',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
                     else
                        scatter(exp_value.aoa(k), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir), 100, 'o', 'Color', '#1a91c2','HandleVisibility','off',   'LineWidth', 1, MarkerFaceColor = '#1a91c2', MarkerEdgeColor = '#1a91c2')
                        x_vec = [exp_value.aoa(k5), exp_value.aoa(k)];
                        y_vec = [exp_value.f_median(k5, lift_dir) / exp_value.f_median(k5, drag_dir), exp_value.f_median(k, lift_dir) / exp_value.f_median(k, drag_dir)];
                        plot(x_vec, y_vec, '-.', 'Color', '#1a91c2', 'HandleVisibility', 'off', 'LineWidth', 3)
                    end
